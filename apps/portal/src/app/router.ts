...
import { createEnterOtpRoutes } from './views/auth/enter-otp/index.ts';
import { createMyPlansRoutes } from './views/my-plans/index.ts';
...
export function buildRouter(service: PortalService): IRouter {
	...
	router.use('/', createEnterOtpRoutes());
	router.use('/', createMyPlansRoutes());
